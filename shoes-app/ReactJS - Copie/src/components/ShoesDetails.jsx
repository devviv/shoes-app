import product from "../assets/img/products/apple-watch.png"
import product_2 from "../assets/img/products/img1-removebg-preview (1).png"
    ...
    <div className="grid gap-3 grid-cols-1 md:grid-cols-2 py-8 px-4">
        <div className="col-span-1 items-center">
            <div className="image rounded-xl p-2 bg-gray-400 shadow-lg w-full h-96">
                <img src={product} alt="" className="object-contain w-full h-full" />
            </div>
            <div className="color-images mt-4 flex flex-wrap">
                <img src={product} alt="" className="h-20 w-20 border-2 p-1 m-2 border-black rounded-lg" />
                <img src={product} alt="" className="h-20 w-20 border-2 p-1 m-2 rounded-lg" />
                <img src={product} alt="" className="h-20 w-20 border-2 p-1 m-2 rounded-lg" />
                <img src={product} alt="" className="h-20 w-20 border-2 p-1 m-2 rounded-lg" />
        ...
        <div className="details md:ml-4 col-span-1">
            <div className="content px-3">
                <h1 className="text-2xl font-bold mb-4">Produit 1</h1>
                ...
                <h1 className="text-start py-2 mb-4">
                    <span className="text-3xl font-extrabold mr-8">30.000 FCFA</span>
                </h1>
                <p className="items-center">Couleurs <span className="text-black font-semibold"> <span
                            className="font-bold">.</span> Noir</span></p>
                <div className="color-images mt-2 flex">
                    <img src={product} alt="" className="h-14 border-2 p-1 mx-2 border-black rounded-lg" />
                    <img src={product} alt="" className="h-14 border-2 p-1 mx-2 rounded-lg" />
                    <img src={product} alt="" className="h-14 border-2 p-1 mx-2 rounded-lg" />
                </div>
                ...
                <div className="color-images flex flex-wrap">
                    <p
                        className="px-6 py-2 border-2 border-gray-300 rounded-md shadow-lg focus:bg-black focus:text-white m-1">
                        40</p>
                    <p
                        className="px-6 py-2 border-2 border-gray-300 rounded-md shadow-lg focus:bg-black focus:text-white m-1">
                        40</p>
            ...
            <div>
                <div className="cart-like flex">
                    <a href="#"
                        className=" w-5/6 m-3 px-6 py-3 rounded-lg text-center items-center text-white hover:text-first-100 bg-first-100  hover:bg-second-100">
                    ...
                    <a href="#"
                        className=" m-3 p-3 rounded-lg m text-center items-center  text-first-100 hover:text-second-100 bg-second-100 hover:bg-first-100">
