...
import logoJaune from '../assets/img/logo-jaune-1.png'
            ...
            <nav class="bg-white border-gray-200 dark:bg-gray-900">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <Link to={`/`} class="flex items-center space-x-3 rtl:space-x-reverse">
                        <img src={logoJaune} class="h-8" alt="Flowbite Logo" />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Shoes Lux</span>
                    </Link>
                        ...
                        <ul
                            ...
                            <Link to={`/cart`}>
                                <li>
                                    ...
                                    <span className='text-red-700 absolute font-bold ml-4 -mt-2 bg-slate-300 rounded-full w-6 h-6 text-center'> {panier.length} </span>
                            ...
                            <Link to={`/heart`}>
                            <li>
                                <span className='text-red-700 absolute font-bold ml-4 -mt-2 bg-slate-300 rounded-full w-6 h-6 text-center'> {heart.length} </span>
                                <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                    viewBox="0 0 24 24">
                                    <path
                            ...
                            <li>
                                <img src={profile} alt="userprofile" className="rounded-full w-12 h-12" />
                            </li>
                        </ul>
                    </div>
                </div>
